...
namespace test
{
    public class OrderRepositoryTests : IDisposable
    {
        ...
        public async Task GetEntriesForOrder_ShouldReturnEntries_WhenOrderExistsWithEntries()
        {
            ...
            {
                new OrderEntry { Id = 1, OrderId = 1, Quantity = 5, Product = paper },
                new OrderEntry { Id = 2, OrderId = 1, Quantity = 10, Product = paper }
            };
        ...
        public void GetProductsPrices_ShouldReturnCorrectPrices_WhenProductsExist()
        {
            ...
            {
                new Paper { Id = 1, Price = 10.0 ,Name = "test"},
                new Paper { Id = 2, Price = 20.0 ,Name = "test2"}
            };
            ...
            {
                new OrderEntryPlaced { ProductId = 1 },
                new OrderEntryPlaced { ProductId = 2 }
            };
        ...
        public async Task GetCustomerOrderHistory_ShouldReturnOrders_WhenCustomerExists()
        {
            ...
            var orders = new List<Order>
            {
                new Order { Id = 1, CustomerId = 1, Status = "Completed" },
                new Order { Id = 2, CustomerId = 1, Status = "Pending" }
            };
            _dbContext.Customers.Add(customer);
            _dbContext.Orders.AddRange(orders);
            _dbContext.SaveChanges();
