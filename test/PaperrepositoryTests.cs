...
namespace test
{
    public class PaperRepositoryTests : IDisposable
    {
        ...
        public async Task GetPapersByFilter_ReturnsPapersWithCorrectFilters()
        {
            ...
            var papers = new List<Paper>
            {
                ...
                { 
                    ...
                    { 
                        new Property { Id = 1, PropertyName = "Glossy" }
                    } 
                },
                new Paper 
                { 
                    ...
                    Properties = new List<Property> 
                    { 
                        new Property { Id = 2, PropertyName = "Matte" }
                    } 
                },
                new Paper 
                { 
                    ...
                    Properties = new List<Property> 
                    { 
                        new Property { Id = 3, PropertyName = "Recycled" }
                    } 
                }
            };
        ...
        public async Task GetPapersByFilter_ReturnsCorrectPageOfResults()
        {
            ...
            var papers = new List<Paper>
            {
                new Paper { Id = 1, Name = "Paper A", Price = 10, Stock = 100, Discontinued = false, Properties = new List<Property> { new Property { Id = 1, PropertyName= "Glossy" } } },
                new Paper { Id = 2, Name = "Paper B", Price = 20, Stock = 200, Discontinued = false, Properties = new List<Property> { new Property { Id = 2, PropertyName= "Matte" } } },
                new Paper { Id = 3, Name = "Paper C", Price = 30, Stock = 300, Discontinued = true, Properties = new List<Property> { new Property { Id = 3, PropertyName = "Recycled" } } },
                new Paper { Id = 4, Name = "Paper D", Price = 40, Stock = 400, Discontinued = true, Properties = new List<Property> { new Property { Id = 4, PropertyName = "Textured" } } }
            };
        ...
        public async Task EditPaperProperty_ShouldThrowExceptionIfPropertyNotFound()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<KeyNotFoundException>(() => _paperRepository.EditPaperProperty(nonExistentPaperProperties));
        }
        ...
        public async Task GetPriceRange_ShouldReturnCorrectPriceRange_WhenPapersExist()
        {
            ...
            var papers = new List<Paper>
            {
                new Paper { Id = 1, Name = "Paper A", Price = 10, Stock = 100 },
                new Paper { Id = 2, Name = "Paper B", Price = 20, Stock = 200 },
                new Paper { Id = 3, Name = "Paper C", Price = 30, Stock = 300 }
            };
            _dbContext.Papers.AddRange(papers);
            _dbContext.SaveChanges();
